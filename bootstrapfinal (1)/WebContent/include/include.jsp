...
<%-- 	<div id="header_wrap">
				...
				<ul id="header_line1_ul">
					<c:choose>
							<c:when test="${empty sessionScope.loginUser}">
								<li><a href="login.bizpoll" id="login_btn" class="header_line1_a">로그인</a></li>
								<li><a href="member.bizpoll" class="header_line1_a">회원가입</a></li>
							</c:when>
							<c:otherwise>
								<li id="li_logout">
					...
					<div id="header_line1_dropdown">
						...
						<a href="#">장바구니</a>
						<a href="#">위시리스트</a>
						<a href="member.bizpoll">회원정보</a>
						<a href="member_update.jsp">회원정보 수정</a>
						<a href="pw_update.jsp">비밀번호 수정</a>
		...
		<div id="header_line2">
		<a href= "#">
			<img id="header_logo"src="img/realsoccer.png" alt="로고">
		</a>
			...
			<li><a id="header_line3_og" href="">유니폼</a>
				<div id="header_line3_dropdown" >
					<ul>
						<li><a href="">상의</a></li>
						<li><a href="">하의</a></li>
						<li><a id="dropdown_socks" href="">아동용</a></li>
						<li><a href="">심판용</a></li>
					</ul>					
				</div>
			</li>
