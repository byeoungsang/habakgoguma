...
$(document).ready(function(){
	...
	$(document).on("click", "#btn_commit", function(){
		...
		/* 유효성체크 값이 유효한값 확인 끝!!! */
		form.submit(); /* #frm_mem인 애를 submit해라 */
	  	...
	  	<div id="header" class="join_membership" role="banner">
			<h1>
				<a href="http://www.naver.com" class="h_logo">
					<img alt="로고" src="img/realsoccer.png">
				</a>			
			</h1>
		</div>  
			...
			<div class="join_content">
				<div class="row_group">
					...
					<span class="ps_box_int_id">
						<input type="text" id="input_id" name="input_id" class="input_login" title="ID" maxlength=
						"20" placeholder="아이디">
						<input type="button" onclick="" value="아이디 중복확인" class="btn_verify2">
					<label for="id"class="lbl">
					</label>
					</span>
					<span class="error">필수정보입력</span>
					</div>
				<div class="join_row">
					<h3 class="join_title">비밀번호</h3>
					<span class="ps_box_int_pass" id="pswd1Img">
						<input type="password" id="input_pw" name="input_pw" class="input_login" title="비빌번호 입력"
						aria-describedby="wa_pw_help" maxlength="20" placeholder="비밀번호">
						<label data-gt-i18n="form.pwsd1" for="pswd1" class="lbl">
							<span id="pswd1Span" class="step_txt"></span>
						</label>
					</span>
					<span class="error">필수정보입력</span>
					<h3 class="join_title">비밀번호 재확인</h3>
					<span class="ps_box_pass_check" id="pswd2Img">
						<input type="password" id="input_pw2" name="input_pw2" title="비밀번호 재확인 입력"
						maxlength="20" class="input_login" placeholder="비밀번호 재확인">
						<label data-tg-il8n="form.pswd2" for="pswd2" class="lbl"></label>
					</span>
					<span class="error">필수정보입력</span>
				</div>
				</div>
				<div class="row_group">
					<div class="join_row">
						...
						<span class="ps_box_right_space">
							<input type="text" id="input_name" name="input_name" title="이름" class="input_login"
							maxlength="40" placeholder="이름">
					...
					<div class="join_birthday">
						...
						<div class="bir_wrap">
							<div class="bir_yy">
								<span class="ps_box">
								<input type="text" id="input_yy" name="input_yy" placeholder="년(4자)" class="input_login"
								maxlength="4">
						...
						<div class="bir_mm">
							<span class="ps_box">
								<select id="input_mm" title="월" class="sel">
									<option>월</option>
								<option value="01">
								                      01
						...
						<div class="bir_dd">
							<span class="ps_box">
								<input type="text" id="input_dd" placeholder="일" class="input_login" 
								maxlength="2">
						...
						<div class="gender_code">
							<select id="input_gender" name="gender" title="성별" class="sel">
						...
						<div class="join_email">
							...
							<span class="email_box">
								<input type="text" id="e_input1" name="e_input1" maxlength="100" placeholder="선택입력"
								class="input_login">
								<label for="email" class="lbl"></label>
							</span>
								<td> 뉴스 메일을 받으시겠습니까?
									<label for="is_news_mail">
										<input id="input_is_news_mail" name="is_news_mail" fw-label="is_news_mail"
										fw-msg class="ec-base-chk" value="T" type="checkbox">
									동의함
									</label>
								</td>
						</div>
...
<input type="text" id="sample6_address" placeholder="주소" class="double">
<input type="text" id="sample6_address2" placeholder="상세주소" class="double">
        ...
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                document.getElementById('sample6_address2').focus();
					...
					<div class="join_mobile" id="moDiv">
						<h3 class="join_title">연락처</h3>
					<div class="phone_No">
						<span class="no_box">
						<select id="No" name="No" title="번호" class="sel">
							<option>번호</option>
							<option value="010">
								010
							</option>
					...
					<div class="no_mid">
						<span class="no_box">
							<input type="text" id="mid" name="mid" class="int"  maxlength ="4">
						</span>
					</div>
					<div class="no_last">
						<span class="no_box">
							<input type="text" id="last" name="last" class="int" maxlength="4">
						</span>
					</div>
					<div class="agree">
						<h3>이용약관 동의</h3>
					...
					<div class="btn_area">
						<a href="#"  type="button" id="btnjoin" class="btnjoin">
							<span>가입하기</span>
						</a>
					</div>
					</div>
